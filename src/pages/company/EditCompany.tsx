...
//       // Собираем только измененные поля для PATCH запроса
...
//   const onCancel = () => {
//     // Reset to original data or navigate back
//     if (originalFormData) {
...
//         <Box sx={{ p: 1, bgcolor: '#ffe', color: '#333', fontSize: '0.8rem' }}>
//           Debug: CompanyId = {companyId || 'undefined'} | Has data:{' '}
